...
fse.register_device(Railway::SignalCmp.new("cmp_s1", "s1", ["interlocking1", "interlocking2"]))
fse.register_device(Railway::PointCmp.new("cmp_p1", "p1", ["interlocking1", "interlocking2"]))
