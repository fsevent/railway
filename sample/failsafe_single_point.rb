...
fse.register_device(Railway::SaferSignal.new("safer_r1", "r1", "interlocking1", "interlocking2"))
fse.register_device(Railway::SaferPoint.new("safer_p1", "p1", "interlocking1", "interlocking2"))
fse.register_device(FSEvent::ValueIdDevice2.new("vp1", "safer_p1", "p1"))
fse.register_device(Railway::Point.new("p1", 1, "vp1", "p1"))
fse.register_device(FSEvent::ValueIdDevice2.new("vr1", "safer_r1", "r1"))
