...
fse.register_device(Railway::SignalCmp.new("safer_s1", "s1", "interlocking1", "interlocking2"))
fse.register_device(Railway::PointCmp.new("safer_p1", "p1", "interlocking1", "interlocking2"))
