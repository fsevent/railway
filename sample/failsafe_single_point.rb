# failsafe_single_point.rb --- failsafe sample with single point
#
...
fse.register_device(Railway::Interlocking.new("interlocking2", "panel", "circuit", facilities))
fse.register_device(Railway::Cmp.new("cmp_s1", "s1", ["interlocking1", "interlocking2"]))
fse.register_device(Railway::Cmp.new("cmp_p1", "p1", ["interlocking1", "interlocking2"]))
fse.register_device(FSEvent::ValueIdDevice2.new("vp1", "cmp_p1", "p1"))
fse.register_device(Railway::Point.new("p1", 1, "vp1", "p1"))
fse.register_device(FSEvent::ValueIdDevice2.new("vs1", "cmp_s1", "s1"))
