...
facilities.add_switch "s1", "n2", ["n3", 5], ["n8", 5]
facilities.add_track "t3", "n3", "n4", 200
facilities.add_track "t5", "n5", "n6", 200
facilities.add_switch "s2", "n6", ["n7", 5], ["n4", 5]
facilities.add_track "t7", "n7", "n8", 200

facilities.add_route "r1", nil, [["n1", "n2", "t1"]]
facilities.add_route "r2", nil, [["n2", "n3", "s1"], ["n3", "n4", "t3"]]
facilities.add_route "r4", nil, [["n4", "n6", "s2"], ["n6", "n5", "t5"]]

facilities.add_route "r5", nil, [["n5", "n6", "t5"]]
facilities.add_route "r6", nil, [["n6", "n7", "s2"], ["n7", "n8", "t7"]]
facilities.add_route "r8", nil, [["n8", "n2", "s1"], ["n2", "n1", "t1"]]
...
fse.register_device(FSEvent::ValueIdDevice2.new("vs2", "interlocking1", "s2"))
...
fse.register_device(Railway::Switch.new("s2", 1, "vs2", "s2"))
